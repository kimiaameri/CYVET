...
# -*- coding: utf-8 -*-
"""
Created on Wed Feb 19 03:46:40 2020
...
csv_data_input=open ('/Users/kimiaameri/Dropbox/CYVET_code/find_score/vendors_webcontent_sorted.csv', 'r', encoding='utf-8', newline='')
csv_reader = csv.reader(csv_data_input, delimiter=',')  
with open ('vendors_train.csv', 'w', encoding='utf-8', newline='') as train:
    csv_writer = csv.writer(train)
    csv_writer.writerow(['vendor','Homepage','Category','text'])
    for row in csv_reader:
      ...
      try:
            ...
            try:
                ...
                #text=text_from_html.replace("\n"," ")
                csv_writer.writerow([vendor,url,Category,text_from_html])
            except Exception:
                pass
      except Exception:
          pass
...
#                   main 
#--------------------------------------------------------------------
data=pd.read_csv('vendors_train.csv')
